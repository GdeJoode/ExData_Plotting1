...
# --> additional plot Global_reactive_power against Time
plot(tabAll$Time, tabAll$Global_reactive_power, type="l",xlab = "datetime", ylab="Global_reactive_power")

dev.copy(png, file="Plot4.png", bg="white",width=480, height=480, units="px")
dev.off()
